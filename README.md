# CRYPT — S2 Smart Home Processor V1.1.17
...
- **Play to** groups (Sonos-style): this TOSLINK only until you add a linked jack. Linked shelves are not overwritten by a global Unison switch. Add a host while playing — it copies, then CLOCK-steers. Still copy-then-play, not ffmpeg HTTP.
