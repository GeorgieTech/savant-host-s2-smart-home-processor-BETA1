# CRYPT — S2 Smart Home Processor V1.1
...
**Current release: [V1.1](https://github.com/GeorgieTech/savant-host-s2-smart-home-processor-BETA1/releases/tag/v1.1.0)** (`v1.1.0`). Previous: [V1.0](https://github.com/GeorgieTech/savant-host-s2-smart-home-processor-BETA1/releases/tag/v1.0.0).
...
- **Playing** page: now playing, FFT visualizer, Rekordbox-style 3-band waveform (pre-analyzed lows/mids/highs), Time Clock vs decoder timing, transport, and the next 5 tracks in queue
