# CRYPT — S2 Smart Home Processor V1.0
...
**Current release: [V1.0](https://github.com/GeorgieTech/savant-host-s2-smart-home-processor-BETA1/releases/tag/v1.0.0)** (`v1.0.0`).
