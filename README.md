# CRYPT — S2 Smart Home Processor V1.1.6
...
- **Report** page: artist / song / album report for later Instagram posts, with an optional MusicBrainz + Wikipedia research plugin
